...
export const createReview = async (req, res, next) =>{
    ...
    if(req.isSeller) return next(createError(403, "Sellers are prohibited to create a review"));
    ...
    try{
        ...
        if(review) return next(createError(403, "You have already posted a review!"));
