        ...
        <div className="sections">
          <div className="info">
            ...
            <option value="" selected disabled>Select Category</option>
              ...
              <option value="music">Social Media Management</option>
              <option value="music">Writing and content creation</option>
              <option value="music">Graphic design</option>
              <option value="music">Translation services</option>
              <option value="music">Virtual assistant</option>
            </select>
